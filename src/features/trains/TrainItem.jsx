    ...
    <div className="overflow-hidden rounded-xl bg-white p-6 shadow-lg transition-all hover:shadow-xl">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-cyan-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-cyan-700 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:outline-none"
        >
          Select Train
        </button>
      </div>
