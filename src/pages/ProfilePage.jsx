        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-8 flex items-center justify-between">
            ...
            <button
              ...
              disabled={isPending}
              className="mr-12 ml-auto flex items-center gap-2 rounded-lg bg-gradient-to-r from-red-500 to-red-600 px-4 py-2 text-sm font-medium text-white transition-all hover:from-red-600 hover:to-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none sm:mr-0 sm:text-base"
            >
              <span>Logout</span>
                ...
                <div className="relative">
                  <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-white shadow-lg sm:h-32 sm:w-32">
                    {!user_metadata.avatar_url ? (
                      <span className="text-2xl font-bold text-cyan-600 sm:text-3xl">
